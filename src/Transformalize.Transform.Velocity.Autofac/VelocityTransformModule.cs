...
namespace Transformalize.Transforms.Velocity.Autofac {
   public class VelocityTransformModule : Module {
      ...
      protected override void Load(ContainerBuilder builder) {
         ...
         var signatures = new VelocityTransform().GetSignatures().ToArray();
         ...
         RegisterTransform(builder, c => new VelocityTransform(c), signatures);
      }
